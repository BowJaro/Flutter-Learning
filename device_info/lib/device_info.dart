...
class MyDeviceInfoPage extends StatefulWidget {
  const MyDeviceInfoPage({super.key});

  @override
  State<MyDeviceInfoPage> createState() => _MyDeviceInfoPageState();
}

class _MyDeviceInfoPageState extends State<MyDeviceInfoPage> {
