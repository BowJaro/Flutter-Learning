...
class MoveZoomWidget extends StatefulWidget {
  const MoveZoomWidget({super.key});

  @override
  State<MoveZoomWidget> createState() => _MoveZoomWidgetState();
}

class _MoveZoomWidgetState extends State<MoveZoomWidget> {
  Offset _startLastOffset = Offset.zero;
  Offset _lastOffset = Offset.zero;
  Offset _currentOffset = Offset.zero;
  double _lastScale = 1.0;
  double _currentScale = 1.0;
  final String _imageUrl = 'assets/images/windows11.jpg';
  @override
